function init_gems(){
	...
	incomum:    new GemData("Gema de Ametista", spr_ametist,	30	),
    raro:		new GemData("Gema de Safira",	spr_saphire,	75	),
	epico:		new GemData("Gema de Rubi",		spr_ruby,		150	),
    lendario:	new GemData("Gema de Diamante", spr_diamond,	300	)
	};
}
...
function create_gem(_name,_sprite,_value,_description) constructor {
    ...
    on_use = function() {
		global.money += value;
		audio_play_sound(snd_sell_gem,1,0)
